...
class Graph_small_to_small:
    ...
    def apply_HH_small_to_small(self):
        ...
        while sequence:
            ...
            first_vertex_degree = sequence.pop(0)
    ...
    def create_graph(self):
        ...
        if self.apply_HH_small_to_small():
            ...
            self.vertices.sort(key=lambda x: x[1], reverse=False)

            while self.vertices and self.vertices[-1][1] != 0:

                if len(self.vertices) == 1 and self.vertices[0][1] != 0:
                    break

                selected_vertex = self.vertices[0]
            ...
            with open("Group3-250-6225-Input-1-Output-4-HH_small_to_small.txt", "w") as file:
    ...
    def pairwise_edge_interchange(self):
        ...
        # here connected_vertex is a number
...
example = "Group3-50-245-Input-1.txt.txt"

graph = Graph_small_to_small(example)
