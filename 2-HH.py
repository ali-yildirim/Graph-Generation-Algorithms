...
class Graph_high_to_high:
    ...
    def apply_HH_high_to_high(self):
    ...
    def create_graph(self):
        ...
        if self.apply_HH_high_to_high():
            ...
            with open("Group3-250-6225-Input-1-Output-2-HH_high_to_high.txt", "w") as file:
    ...
    def pairwise_edge_interchange(self):
        ...
        # here connected vertex is a plain number, we simply take the number of the vertex
...
graph = Graph_high_to_high(example)
